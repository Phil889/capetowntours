...
export const tokaraWineEstateReviews: Review[] = [
  {
    id: "1",
    name: "Hans Mueller",
...
export const boschendalWineEstateReviews: Review[] = [
  {
    id: "1",
    name: "Sophie Laurent",
...
export const aquilaSafariReviews: Review[] = [
  {
    id: "1",
    name: "Michael Brown",
    location: "London, UK",
...
export const inverdoornSafariReviews: Review[] = [
  {
    id: "1",
    name: "Anna Petrov",
...
export const bouldersBeachPenguinsReviews: Review[] = [
  {
    id: "1",
    name: "Lisa Schmidt",
...
export const tableMountainReviews: Review[] = [
  {
    id: "1",
    name: "Erik Johansson",
...
export const capePointReviews: Review[] = [
  {
    id: "1",
